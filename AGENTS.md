# Codex instructions for Inmolink
...
Multi-agent real-estate marketplace for EU agencies. Solo developer, vibe-coded with Codex. v1 in progress. Designed for 500 → 5,000 agents, 20-30K properties each, ~50 images per property → 150M-property / 7.5B-image ceiling.
...
- **`packages/ai`** Codex Haiku icon suggester + translation drafts
...
- Read **memory** at session start: `C:\Users\Shah PC\.Codex\projects\E--Repos-Inmolink\memory\` (especially `inmolink_state.md` for resume readiness)
